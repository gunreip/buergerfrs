{{-- resources/views/components/ui/tw-graph-protocol/primitives/arc-sw.blade.php --}}
{{--
    Primitive arc-sw element.

    Usage:
    <x-ui.tw-graph-protocol.primitives.arc-sw ... />
--}}
...
<span
    {{ $attributes->class('tw-graph-protocol-primitive tw-graph-protocol-primitive-arc tw-graph-protocol-primitive-arc-sw')->style([
