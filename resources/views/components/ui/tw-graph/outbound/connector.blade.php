{{-- resources/views/components/ui/tw-graph/outbound/connector.blade.php --}}
{{--
    Deprecated alias:
    Prefer <x-ui.tw-graph.outbound.connector-horizontal ... /> for left-to-right connectors.

    Usage:
    <x-ui.tw-graph.outbound.connector side="left" length="2.5rem" />
    <x-ui.tw-graph.outbound.connector length="5rem" color="sky" />
