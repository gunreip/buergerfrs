{{-- resources/views/components/ui/tw-graph-v2/elements/arc/sw.blade.php --}}
{{--
    Geometry note:
    This element is only the visual south-west arc primitive. The arc box uses
    ...
    <x-ui.tw-graph-v2.elements.arc.sw color="amber" />
...
<div
    ...
    @endif
    {{ $attributes->class('tw-graph-v2-element-arc tw-graph-v2-element-arc-sw')->style([
