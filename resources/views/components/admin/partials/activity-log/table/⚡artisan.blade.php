{{-- resources/views/components/admin/partials/activity-log/table/⚡artisan.blade.php --}}
...
{{-- Artisan Logs: command/CLI focused activity_log table --}}
<div
    class="mx-auto max-w-full scroll-mt-6"
    id="activity-log-table"
>
    <div class="overflow-hidden rounded-t-lg">
        {{-- Artisan Activity-Log Table --}}
        <flux:table container:class="app-table">

            {{-- Artisan Activity-Log-Header Row --}}
            <flux:table.columns
            ...
            <flux:table.rows>
                @forelse ($activityLogs as $activityLog)
                    ...
                    {{-- Table-Row --}}
                    <flux:table.row wire:key="activity-log-artisan-{{ $id }}">
                        ...
                        {{-- Table-Cell Actor --}}
                        <flux:table.cell class="w-px whitespace-nowrap align-top">
                            @if ($actorTerminalUser !== '' || $actorType !== '')
                    ...
                    <flux:table.row>
                        ...
                        <flux:table.cell colspan="11">
                            <div class="py-8 text-center text-sm text-zinc-500 dark:text-zinc-400">
                                {{ __('No artisan activity log entries found for the selected filters.') }}
                            </div>
                        </flux:table.cell>
                    </flux:table.row>
                @endforelse
