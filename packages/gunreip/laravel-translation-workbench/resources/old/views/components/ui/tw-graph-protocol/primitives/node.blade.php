{{-- resources/views/components/ui/tw-graph-protocol/primitives/node.blade.php --}}
{{--
    Primitive: node

    Usage:
    <x-ui.tw-graph-protocol.primitives.node anchor-x="0rem" anchor-y="0rem" />

    Rule:
    node renders only a point marker. Segments decide whether a node should be
    visible at a start anchor, end anchor, or DEV-only inspection point.
--}}
