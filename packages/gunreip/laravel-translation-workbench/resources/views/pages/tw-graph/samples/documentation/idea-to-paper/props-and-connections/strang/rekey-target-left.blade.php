<section class="min-w-0 space-y-4" id="reference-strang-rekey-target-left">
    <flux:heading size="lg">strang.rekey-target-left — Deep Reference</flux:heading>
    <x-translation-workbench::ui.tw-graph.documentation-links reference="strang.rekey-target-left" />
    <flux:text>Left rekey target route starting at an existing anchor and ending with a cap.</flux:text>
    ...
    <flux:callout class="min-w-0 space-y-3" color="green" icon="brackets">
        ...
        <x-translation-workbench::ui.tw-graph.code-box class="mt-3">&lt;x-translation-workbench::ui.tw-graph.strang.rekey-target-left
    id=&quot;example.rekey-target-left&quot;
...
/&gt;</x-translation-workbench::ui.tw-graph.code-box>
    ...
    <flux:callout class="min-w-0 space-y-3" color="amber" icon="cable">
        ...
        <flux:table class="mt-3">
            ...
            <flux:table.rows>
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal align-top">strang.rekey-target-left.start</flux:table.cell>
                ...
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal align-top">strang.rekey-target-left.end</flux:table.cell>
                    <flux:table.cell class="whitespace-normal align-top">anchor</flux:table.cell>
    ...
    <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">.../props-and-connections/strang/rekey-target-left.blade.php</flux:field>
</section>
