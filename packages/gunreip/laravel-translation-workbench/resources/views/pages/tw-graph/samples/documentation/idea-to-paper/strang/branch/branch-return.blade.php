<section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
    ...
    >
        ...
        @php
            ...
            if (
                preg_match(
                    '/^[ \t]*\{\{-- branch-return-example-1:start --\}\}\R(.*?)^[ \t]*\{\{-- branch-return-example-1:end --\}\}/ms',
                    $docExampleSource,
                    $docExample1Match,
                ) !== 1
            ) {
                throw new \LogicException('Missing branch-return-example-1 source markers.');
            }
        ...
        <flux:heading
            class="mt-4"
            size="sm"
        >{{ __('Branch return props') }}</flux:heading>
    ...
    >
        ...
        <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">
            .../strang/branch/branch-return.blade.php</flux:field>
    </flux:callout>
</section>
