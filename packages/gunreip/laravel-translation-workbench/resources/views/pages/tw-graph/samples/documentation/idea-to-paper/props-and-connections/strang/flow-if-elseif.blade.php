<section class="min-w-0 space-y-4" id="reference-strang-flow-if-elseif">
    <flux:heading size="lg">strang.flow-if-elseif — Deep Reference</flux:heading>
    <x-translation-workbench::ui.tw-graph.documentation-links reference="strang.flow-if-elseif" />
    <flux:text>One IF followed by exactly one ELSEIF, then a fallback/bypass.</flux:text>
    ...
    <flux:callout class="min-w-0 space-y-3" color="green" icon="brackets">
        ...
        <flux:accordion>
            ...
            <flux:accordion.item>
                ...
                <flux:accordion.content>
                    <flux:text>Exactly one entry. key is not used by this single-ELSEIF wrapper.</flux:text>
                    <flux:table class="mt-3">
                        <flux:table.columns sticky>
                            <flux:table.column>Prop / path</flux:table.column>
                            <flux:table.column>Type</flux:table.column>
        ...
        <x-translation-workbench::ui.tw-graph.code-box class="mt-3">&lt;x-translation-workbench::ui.tw-graph.strang.flow-if-elseif
    id=&quot;example.flow-if-elseif&quot;
    side=&quot;left&quot;
    :elseifs=&quot;[
...
/&gt;</x-translation-workbench::ui.tw-graph.code-box>
    ...
    <flux:callout class="min-w-0 space-y-3" color="sky" icon="variable">
        ...
        <flux:text>The first IF action supports return=false, but this wrapper does not apply its returnOffset. The inner single IF supplies the ELSEIF route geometry. Use the multi variant when you need the more flexible nested-branch layout.</flux:text>
    </flux:callout>
    <flux:callout class="min-w-0 space-y-3" color="amber" icon="cable">
        ...
        <flux:table class="mt-3">
            ...
            <flux:table.rows>
                ...
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal align-top">{id}.elseif.true.anchorNode-end</flux:table.cell>
                    <flux:table.cell class="whitespace-normal align-top">anchor</flux:table.cell>
                ...
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal align-top">{id}.elseif.true.anchorNode-return</flux:table.cell>
                    <flux:table.cell class="whitespace-normal align-top">anchor</flux:table.cell>
