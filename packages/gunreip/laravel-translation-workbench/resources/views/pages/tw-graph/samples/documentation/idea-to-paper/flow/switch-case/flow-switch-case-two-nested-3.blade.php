<x-translation-workbench::ui.common.heading-counter-group group="flow-switch-case-two-nested-3">
                ...
                <flux:accordion.item expanded>
                    <flux:callout icon="code" color="indigo">
                        <x-translation-workbench::ui.common.heading-counter
                            example="flow-switch-case-two-nested-3-example-1"
                            variant="accordion"
                    ...
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $docExampleSource->example('flow-switch-case-two-nested-3-example-1') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
                <flux:accordion.item>
                    <flux:callout icon="code" color="indigo">
                        <x-translation-workbench::ui.common.heading-counter
                            example="flow-switch-case-two-nested-3-example-2"
                            variant="accordion"
                            :prefix-text="__('Complete example')"
                    ...
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $docExampleSource->example('flow-switch-case-two-nested-3-example-2') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
            </flux:accordion>
                    ...
                    <flux:table container:class="max-h-80">
                        ...
                        <flux:table.rows>
                            ...
                            <flux:table.row>
                                ...
                                <flux:table.cell class="wrap-break-word whitespace-normal align-top">
                                    {{ __('16rem here: keeps the crossing in the outgoing bridge, beyond the action text.') }}
                                </flux:table.cell>
                            </flux:table.row>
                            <flux:table.row>
                                <flux:table.cell class="wrap-break-word whitespace-normal align-top">
                                    <code>cases[].actionLabel.lineJumps<br>case-default.lineJumps<br>parts.sideways :line-jumps</code>
                                </flux:table.cell>
                                <flux:table.cell class="wrap-break-word whitespace-normal align-top">
                                    <code>[]</code>
                                </flux:table.cell>
                                <flux:table.cell class="wrap-break-word whitespace-normal align-top">
                                    {{ __('Explicit crossings: over identifies the crossed line, radius sets the jump size and side=top places it above the bridge. Missing or invalid crossings produce DEV mismatch diagnostics.') }}
                                </flux:table.cell>
                            </flux:table.row>
                        </flux:table.rows>
                    </flux:table>
