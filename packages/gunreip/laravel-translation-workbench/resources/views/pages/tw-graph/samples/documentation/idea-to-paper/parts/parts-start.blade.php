            ...
            <flux:table container:class="max-h-80">
                ...
                <flux:table.rows>
                    ...
                    <flux:table.row>
                        ...
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">Length from the start to the calculated end anchor.</flux:table.cell>
                    </flux:table.row>
                    <flux:table.row>
                        ...
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">Fade at the start; false renders a plain line.</flux:table.cell>
                    </flux:table.row>
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">node-end</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">true</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">Enable the endpoint and its optional labels.</flux:table.cell>
                    </flux:table.row>
                    <flux:table.row>
                        ...
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">Use a joint arrow at an unlabelled endpoint.</flux:table.cell>
                    </flux:table.row>
                    <flux:table.row>
                        ...
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">Explicitly override endpoint dot visibility.</flux:table.cell>
                    </flux:table.row>
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">start-label</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">null</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">Text or label configuration at the starting anchor.</flux:table.cell>
                    </flux:table.row>
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">node-label-left</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">null</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">Label configuration on the left of the endpoint.</flux:table.cell>
                    </flux:table.row>
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">node-label-right</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">null</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">Label configuration on the right of the endpoint.</flux:table.cell>
                    </flux:table.row>
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">node-image</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">null</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">Optional endpoint image.</flux:table.cell>
                    </flux:table.row>
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">dev-counter-end</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">1</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">Endpoint counter; false hides the counter.</flux:table.cell>
                    </flux:table.row>
                    <flux:table.row>
