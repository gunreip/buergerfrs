<x-translation-workbench::ui.common.heading-counter-group group="strang-rekey-compressed">
    <section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
                ...
                <flux:accordion.item expanded>
                    <flux:callout icon="code" color="indigo">
                        <x-translation-workbench::ui.common.heading-counter
                            example="rekey-compressed-example-1"
                            variant="accordion"
                            :prefix-text="__('Complete example')"
                        >{{ __('Rekey compressed') }}</x-translation-workbench::ui.common.heading-counter>
                    </flux:callout>
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $docExampleSource->example('rekey-compressed-example-1') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
            </flux:accordion>
            <flux:separator class="mt-4" :text="__('Props used in these examples')" />
            <flux:callout color="indigo">
                <flux:callout.heading icon="variable">{{ __('Rekey compressed props') }}</flux:callout.heading>
        ...
        <flux:callout class="min-w-0" color="emerald">
            ...
            <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">
                .../idea-to-paper/strang/rekey/rekey-compressed.blade.php
            </flux:field>
        </flux:callout>
    </section>
