<section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
    ...
    >
        ...
        @php
            ...
            $docExample1Code = $docExampleSource->example('flow-switch-case-grouped-3-example-1');
            $docExample2Code = $docExampleSource->example('flow-switch-case-grouped-3-example-2');
        @endphp
        <flux:heading
            class="mt-3"
            size="sm"
