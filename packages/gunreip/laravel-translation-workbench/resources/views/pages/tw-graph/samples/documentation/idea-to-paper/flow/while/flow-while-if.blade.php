<section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
    <flux:callout
        ...
        icon="file-text"
    >
        <flux:callout.heading>WHILE with IF / ELSE</flux:callout.heading>
        <flux:callout.text>Read the current item inside the WHILE body. The nested IF processes enabled items or records
            disabled items as skipped. Both IF branches merge before the shared index increment. Only then does the loop
            return to its own condition. An empty list follows the WHILE FALSE exit directly. All components and the
            extra vertical space are explicitly authored below.</flux:callout.text>
        @php
        ...
        >
            ...
            <flux:table.rows>
                ...
                <flux:table.row>
                    ...
                    <flux:table.cell class="whitespace-normal">connection</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">Attach the nested IF here with direction
                ...
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal">inner-if.attach-to</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">null</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">Connects to the open WHILE body. The IF is an
                        independent flow-if-else component.</flux:table.cell>
                </flux:table.row>
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal">inner-if.direction</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">bottom-top</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">Explicitly top-bottom, following the downward WHILE
                        body.</flux:table.cell>
                </flux:table.row>
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal">inner-if.before-length</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">2rem</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">Stem before the IF question, explicitly 1rem. This is
                        the existing IF component API.</flux:table.cell>
                </flux:table.row>
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal">inner-if.after-length</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">2rem</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">Stem after the IF question, explicitly 1rem.
                    </flux:table.cell>
                </flux:table.row>
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal">inner-if.bridge-length</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">inherited</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">Bridges around each IF action, explicitly 2rem.
                    </flux:table.cell>
                </flux:table.row>
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal">inner-if.stem-length</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">8rem</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">Distance between the two IF lanes, explicitly 4rem.
                    </flux:table.cell>
                </flux:table.row>
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal">inner-if.if-start</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">TRUE action</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">Process item when enabled.</flux:table.cell>
                </flux:table.row>
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal">inner-if.if-end</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">FALSE action</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">Record skipped item otherwise; rejoins the same
                        continuation.</flux:table.cell>
                </flux:table.row>
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal">inner-if.anchorNode-end</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">connection</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">Both inner branches converge here. The advance action
                        attaches here, not directly to the WHILE body.</flux:table.cell>
                </flux:table.row>
                <flux:table.row>
                ...
                <flux:table.row>
                    ...
                    <flux:table.cell class="whitespace-normal">Right in the left example and left in the right example, relative to the selected anchor.
                    </flux:table.cell>
                </flux:table.row>
                <flux:table.row>
    ...
    <flux:callout
        ...
        icon="eye"
    >
        <flux:callout.heading>WHILE with IF · left / right</flux:callout.heading>
