<section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
    ...
    >
        ...
        <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">.../strang/rekey/rekey-source.blade.php
        </flux:field>
    </flux:callout>
</section>
