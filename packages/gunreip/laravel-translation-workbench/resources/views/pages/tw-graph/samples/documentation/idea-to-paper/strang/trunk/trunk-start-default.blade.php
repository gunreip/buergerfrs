<x-translation-workbench::ui.common.heading-counter-group group="strang-trunk-start-default">
    <section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
                ...
                <flux:accordion.item expanded>
                    ...
                    >
                        <x-translation-workbench::ui.common.heading-counter
                            example="trunk-start-default-example-1"
                            variant="accordion"
                            :prefix-text="__('Complete example')"
                        >{{ __('Start default') }}</x-translation-workbench::ui.common.heading-counter>
                    </flux:callout>
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $trunkExampleSource->example('trunk-start-default-example-1') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
            </flux:accordion>
            <flux:separator
        ...
        >
            ...
            <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">
                .../idea-to-paper/strang/trunk/trunk-start-default.blade.php
            </flux:field>
        </flux:callout>
    </section>
