{{-- Flow section: flow-branch-steps. Code example and rendered preview. --}}
...
&lt;x-translation-workbench::ui.tw-graph.strang.flow-step
    ...
    <span class="text-lime-300">attach-to="literature.flow.1.paper-process.decision-1.left.anchorNode-end"</span>
...
&lt;x-translation-workbench::ui.tw-graph.strang.flow-step
    ...
    <span class="text-lime-300">attach-to="literature.flow.1.paper-process.decision-1.right.anchorNode-end"</span>
    <span class="text-amber-300">before-length="1.5rem"
    after-length="2.5rem"</span>
    <span class="text-lime-300">:step-label="[
...
<flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">
    {{ '.../tw-graph/samples/documentation/idea-to-paper/05-strang-flow/sections/flow-branch-steps.blade.php' }}
</flux:field>
@endif
