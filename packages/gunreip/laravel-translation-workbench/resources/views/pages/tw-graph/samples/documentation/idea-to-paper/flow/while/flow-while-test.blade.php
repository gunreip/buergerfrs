<x-translation-workbench::ui.common.heading-counter-group group="flow-while-test">
    ...
    >
        ...
        >
            ...
            <flux:callout.text>{{ __('WHILE basic, multiple actions, WHILE with IF, Nested WHILE, Two independent inner loops and Mixed sides and crossings are saved as left/right examples. Current test: Action → Nested WHILE → Action. Prepare a group, process its items, finalize the group and advance the outer index. The SWITCH body variant remains planned.') }}</flux:callout.text>
        </flux:callout>
        <flux:callout
            class="min-w-0"
            color="zinc"
        ...
        >
            ...
            <flux:callout.text>{{ __('Keep the condition separate from body actions. Label TRUE, FALSE and the return direction clearly. The return rejoins the condition after initialization, so initialization is not repeated accidentally. Use conditions and body updates that make progress explicit; drawing a return alone does not guarantee termination.') }}</flux:callout.text>
                ...
                <flux:accordion.item expanded>
                    <flux:callout icon="code" color="indigo">
                        <x-translation-workbench::ui.common.heading-counter
                            example="while-action-sequence-example"
                            variant="accordion"
