        ...
        >
            ...
            <flux:table.rows>
                ...
                <flux:table.row>
                    ...
                    <flux:table.cell>[]</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">Explicit jumps on the action return stem. The right
                        example crosses the continuous source-review bridge with side="right". The left example uses
                        lineJumps on the bridge.</flux:table.cell>
                </flux:table.row>
            </flux:table.rows>
        </flux:table>
    </flux:callout>
