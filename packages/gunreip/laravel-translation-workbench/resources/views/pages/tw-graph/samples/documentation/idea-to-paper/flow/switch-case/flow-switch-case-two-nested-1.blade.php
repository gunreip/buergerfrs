<section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
    ...
    >
        ...
        @php
            ...
            $docExample1Code = $docExampleSource->example('flow-switch-case-two-nested-1-example-1');
            $docExample2Code = $docExampleSource->example('flow-switch-case-two-nested-1-example-2');
        @endphp
        <flux:heading
            class="mt-3"
            size="sm"
        >Outer left · Editable right · Published right</flux:heading>
        <x-translation-workbench::ui.tw-graph.code-box
            class="mt-3">{{ $docExample1Code }}</x-translation-workbench::ui.tw-graph.code-box>
        <flux:heading class="mt-4" size="sm">Outer left · Editable right · Published left</flux:heading>
    ...
    >
        ...
        >
            ...
            <flux:heading
                class="m-3"
                size="sm"
            >Outer left · Editable right · Published left</flux:heading>
            <div
                class="mt-3 overflow-x-auto rounded-lg border border-zinc-200 bg-white/70 dark:border-zinc-700 dark:bg-zinc-900/40">
