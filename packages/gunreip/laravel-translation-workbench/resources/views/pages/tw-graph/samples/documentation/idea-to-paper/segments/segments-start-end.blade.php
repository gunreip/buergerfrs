<section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
    ...
    >
        ...
        <flux:heading
            class="mt-4"
            size="sm"
        >Start · bottom-top</flux:heading>
        <x-translation-workbench::ui.tw-graph.code-box
            class="mt-3">{{ $startBottomTopCode }}</x-translation-workbench::ui.tw-graph.code-box>
        <flux:heading
            class="mt-4"
            size="sm"
        >Start · top-bottom</flux:heading>
        <x-translation-workbench::ui.tw-graph.code-box
            class="mt-3">{{ $startTopBottomCode }}</x-translation-workbench::ui.tw-graph.code-box>
        <flux:heading
            class="mt-4"
            size="sm"
        >End · bottom-top</flux:heading>
        <x-translation-workbench::ui.tw-graph.code-box
            class="mt-3">{{ $endBottomTopCode }}</x-translation-workbench::ui.tw-graph.code-box>
        <flux:heading
            class="mt-4"
            size="sm"
        >End · top-bottom</flux:heading>
        <x-translation-workbench::ui.tw-graph.code-box
            class="mt-3">{{ $endTopBottomCode }}</x-translation-workbench::ui.tw-graph.code-box>
        <flux:heading
            class="mt-4"
            size="sm"
        >{{ __('Start and end segment props') }}</flux:heading>
            ...
            <flux:table container:class="max-h-80 ">
                ...
                <flux:table.rows>
                    ...
                    <flux:table.row>
                        ...
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">null</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">
                            {{ __('Component prop: overrides segment.dev; otherwise defaults to false.') }}
                        </flux:table.cell>
                    </flux:table.row>
                    {{-- Row --}}
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">id</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">segment.start
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">segment.end
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">
                    ...
                    <flux:table.row>
                        ...
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">true</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">false (enforced)
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">
                    ...
                    <flux:table.row>
                        ...
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">false</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">true (enforced)
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">
                    ...
                    {{-- Row --}}
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">capStart
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">false</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">false</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">
                    ...
                    {{-- Row --}}
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">capEnd
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">null</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">null</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">
                    ...
                    {{-- Row --}}
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">capLength
                        </flux:table.cell>
                    ...
                    <flux:table.row>
                        ...
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">not used
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">
                    ...
                    <flux:table.row>
                        ...
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">bottom
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">not used
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">
                    ...
                    <flux:table.row>
                        ...
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">from direction
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">
                    ...
                    {{-- Row --}}
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">startLabel.offset
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">inherited labelGap /
                            graph label_offset</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">not used
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">
                    ...
                    {{-- Row --}}
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">endLabel.offset
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">not used
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">inherited labelGap /
                    ...
                    {{-- Row --}}
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">startLabel.align
                        </flux:table.cell>
                    ...
                    {{-- Row --}}
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">endLabel.align
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">not used
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">center
                    ...
                    {{-- Row --}}
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">endLabel.maxLines
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">not used
                        </flux:table.cell>
                    ...
                    {{-- Row --}}
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">colorGradient
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">false
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">false
                    ...
                    <flux:table.row>
                        ...
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">
                            {{ __('Diagnostic mode inside the segment array; overridden by the component :dev prop.') }}
                        </flux:table.cell>
                    </flux:table.row>
                </flux:table.rows>
            </flux:table>
