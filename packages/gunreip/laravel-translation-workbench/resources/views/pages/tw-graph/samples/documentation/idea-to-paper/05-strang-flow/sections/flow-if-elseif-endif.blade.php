{{-- Flow section: flow-if-elseif-endif. Code example and rendered preview. --}}
...
&gt;
    ...
    &lt;x-translation-workbench::ui.tw-graph.strang.if-else-endif
        ...
        :intro-label="['text' = & gt;
            ['IF / ELSE flow'], 'width' = & gt;
            'half', 'align' = & gt;
            'center'
        ]"
        :if-condition-label="[
            'text' = & gt;
            ['IF color=red', 'THEN RGB(240, 62, 62)'],
            'width' = & gt;
            'default',
            'align' = & gt;
            'left',
        ...
        :elseif-conditions="[
            [
                ...
                [
                    'text' = & gt;
                    ['ELSEIF color=green', 'THEN RGB(12, 166, 120)'],
                    'width' = & gt;
                    'default',
                    'align' = & gt;
                    'left',
            ...
            [
                ...
                [
                    'text' = & gt;
                    ['ELSEIF color=blue', 'THEN RGB(59, 130, 246)'],
                    'width' = & gt;
                    'halfLong',
                    'align' = & gt;
                    'left',
            ...
            [
                ...
                [
                    'text' = & gt;
                    ['ELSEIF color=amber', 'THEN RGB(245, 158, 11)'],
                    'width' = & gt;
                    'long',
                    'align' = & gt;
                    'left',
            ...
            [
                ...
                [
                    'text' = & gt;
                    ['ELSE fallback', 'THEN use default palette'],
                    'width' = & gt;
                    'halfLong',
                    'align' = & gt;
                    'left',
...
@elseif ($sectionContent === 'preview')
    {{-- Flow IF ELSEIF ENDIF: compare the same content in both directions. --}}
    ...
    <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">
        {{ '.../tw-graph/samples/documentation/idea-to-paper/05-strang-flow/sections/flow-if-elseif-endif.blade.php' }}
    </flux:field>
@endif
