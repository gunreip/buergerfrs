<x-translation-workbench::ui.common.heading-counter-group group="strang-trunk-start-spacing">
    <section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
        <flux:callout color="indigo" icon="file-text" class="min-w-0">
            ...
            <x-translation-workbench::ui.tw-graph.documentation-links example="strang.trunk.trunk-start-spacing" />
                ...
                <flux:accordion.item expanded>
                    <flux:callout icon="code" color="indigo">
                        <x-translation-workbench::ui.common.heading-counter
                            example="trunk-start-spacing-example-1"
                            variant="accordion"
                            :prefix-text="__('Complete example')"
                        >{{ __('Start spacing') }}</x-translation-workbench::ui.common.heading-counter>
                    </flux:callout>
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $trunkExampleSource->example('trunk-start-spacing-example-1') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
            </flux:accordion>
        ...
        <flux:callout class="min-w-0" color="emerald">
            ...
            <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">
                .../idea-to-paper/strang/trunk/trunk-start-spacing.blade.php
            </flux:field>
        </flux:callout>
    </section>
