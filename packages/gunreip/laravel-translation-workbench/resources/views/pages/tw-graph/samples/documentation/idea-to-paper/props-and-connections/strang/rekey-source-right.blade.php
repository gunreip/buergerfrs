<section class="min-w-0 space-y-4" id="reference-strang-rekey-source-right">
    <flux:heading size="lg">strang.rekey-source-right — Deep Reference</flux:heading>
    <x-translation-workbench::ui.tw-graph.documentation-links reference="strang.rekey-source-right" />
    <flux:text>Incoming right rekey source with compressed continuation and merge-style attachment.</flux:text>
    ...
    <flux:callout class="min-w-0 space-y-3" color="red" icon="book-open-check">
        ...
        <flux:table class="mt-3">
            ...
            <flux:table.rows>
                ...
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal align-top">compressed-stem-parts</flux:table.cell>
                    <flux:table.cell class="whitespace-normal align-top">array</flux:table.cell>
                    <flux:table.cell class="whitespace-normal align-top">{&quot;beforeLength&quot;: &quot;0.75rem&quot;, &quot;gapLength&quot;: &quot;1rem&quot;}</flux:table.cell>
                    <flux:table.cell class="whitespace-normal align-top">Visible before/gap pieces of a compressed stem; expand below.</flux:table.cell>
                </flux:table.row>
                <flux:table.row>
                ...
                <flux:table.row>
                    ...
                    <flux:table.cell class="whitespace-normal align-top">integer</flux:table.cell>
                    <flux:table.cell class="whitespace-normal align-top">8</flux:table.cell>
                ...
                <flux:table.row>
                    ...
                    <flux:table.cell class="whitespace-normal align-top">length string | null</flux:table.cell>
                    <flux:table.cell class="whitespace-normal align-top">Canvas stem-length → line-length</flux:table.cell>
                    <flux:table.cell class="whitespace-normal align-top">Supported local continuation length attribute.</flux:table.cell>
                </flux:table.row>
            </flux:table.rows>
        </flux:table>
    </flux:callout>
    <flux:callout class="min-w-0 space-y-3" color="green" icon="brackets">
        ...
        <flux:accordion>
            ...
            <flux:accordion.item>
                <flux:accordion.heading>compressed-stem-parts</flux:accordion.heading>
                <flux:accordion.content>
                    <flux:text>Visual compressed stem pieces. The path keeps its logical connection length.</flux:text>
                    <flux:table class="mt-3">
                        <flux:table.columns sticky>
                            <flux:table.column>Prop / path</flux:table.column>
                            <flux:table.column>Type</flux:table.column>
                        ...
                        <flux:table.rows>
                            <flux:table.row>
                                <flux:table.cell class="whitespace-normal align-top">compressed-stem-parts.beforeLength</flux:table.cell>
                                <flux:table.cell class="whitespace-normal align-top">length string</flux:table.cell>
                                <flux:table.cell class="whitespace-normal align-top">0.75rem</flux:table.cell>
                                <flux:table.cell class="whitespace-normal align-top">Visible segment before the gap.</flux:table.cell>
                            </flux:table.row>
                            <flux:table.row>
                                <flux:table.cell class="whitespace-normal align-top">compressed-stem-parts.gapLength</flux:table.cell>
                                <flux:table.cell class="whitespace-normal align-top">length string</flux:table.cell>
                                <flux:table.cell class="whitespace-normal align-top">1rem</flux:table.cell>
                                <flux:table.cell class="whitespace-normal align-top">Gap between visible pieces.</flux:table.cell>
                            </flux:table.row>
                            <flux:table.row>
                                <flux:table.cell class="whitespace-normal align-top">compressed-stem-parts.afterLength</flux:table.cell>
                                <flux:table.cell class="whitespace-normal align-top">length string</flux:table.cell>
                                <flux:table.cell class="whitespace-normal align-top">Calculated remainder</flux:table.cell>
                                <flux:table.cell class="whitespace-normal align-top">Optional visible segment after the gap.</flux:table.cell>
                            </flux:table.row>
                        </flux:table.rows>
                    </flux:table>
                </flux:accordion.content>
        ...
        <x-translation-workbench::ui.tw-graph.code-box class="mt-3">&lt;x-translation-workbench::ui.tw-graph.strang.rekey-source-right
    id=&quot;example.rekey-source-right&quot;
...
/&gt;</x-translation-workbench::ui.tw-graph.code-box>
    ...
    <flux:callout class="min-w-0 space-y-3" color="amber" icon="cable">
        ...
        <flux:table class="mt-3">
            ...
            <flux:table.rows>
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal align-top">strang.rekey-source-right.start</flux:table.cell>
                ...
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal align-top">strang.rekey-source-right.end</flux:table.cell>
                    <flux:table.cell class="whitespace-normal align-top">anchor</flux:table.cell>
    ...
    <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">.../props-and-connections/strang/rekey-source-right.blade.php</flux:field>
</section>
