<section class="min-w-0 space-y-4" id="reference-strang-branch-end">
    <flux:heading size="lg">strang.branch-end — Deep Reference</flux:heading>
    <x-translation-workbench::ui.tw-graph.documentation-links reference="strang.branch-end" />
    <flux:text>Capped ending for a branch on either side.</flux:text>
    ...
    <flux:callout class="min-w-0 space-y-3" color="green" icon="brackets">
        ...
        <x-translation-workbench::ui.tw-graph.code-box class="mt-3">&lt;x-translation-workbench::ui.tw-graph.strang.branch-end
    id=&quot;example.branch-end&quot;
...
/&gt;</x-translation-workbench::ui.tw-graph.code-box>
    ...
    <flux:callout class="min-w-0 space-y-3" color="amber" icon="cable">
        ...
        <flux:table class="mt-3">
            ...
            <flux:table.rows>
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal align-top">strang.branch-end.{side}.start</flux:table.cell>
                ...
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal align-top">strang.branch-end.{side}.end</flux:table.cell>
                    <flux:table.cell class="whitespace-normal align-top">anchor</flux:table.cell>
    ...
    <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">.../props-and-connections/strang/branch-end.blade.php</flux:field>
</section>
