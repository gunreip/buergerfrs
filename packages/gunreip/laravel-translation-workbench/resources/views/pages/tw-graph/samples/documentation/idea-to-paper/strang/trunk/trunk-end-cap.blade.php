<x-translation-workbench::ui.common.heading-counter-group group="strang-trunk-end-cap">
    <section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
        ...
        >
            ...
            <x-translation-workbench::ui.tw-graph.documentation-links example="strang.trunk.trunk-end-cap" />
                ...
                <flux:accordion.item expanded>
                    ...
                    >
                        <x-translation-workbench::ui.common.heading-counter
                            example="trunk-end-cap-example-1"
                            variant="accordion"
                            :prefix-text="__('Complete example')"
                        >{{ __('End cap') }}</x-translation-workbench::ui.common.heading-counter>
                    </flux:callout>
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $trunkExampleSource->example('trunk-end-cap-example-1') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
            </flux:accordion>
            <flux:separator
