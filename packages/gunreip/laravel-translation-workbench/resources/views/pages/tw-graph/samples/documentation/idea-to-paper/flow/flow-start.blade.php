<x-translation-workbench::ui.common.heading-counter-group group="flow-start">
    <section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
                ...
                <flux:accordion.item expanded>
                    <flux:callout icon="code" color="indigo">
                        <x-translation-workbench::ui.common.heading-counter
                            example="flow-start-example-1"
                            variant="accordion"
                            :prefix-text="__('Complete example')"
                        >{{ __('Flow start') }}</x-translation-workbench::ui.common.heading-counter>
                    </flux:callout>
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $docExampleSource->example('flow-start-example-1') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
            </flux:accordion>
            <flux:separator class="mt-4" :text="__('Props used in these examples')" />
            <flux:callout color="indigo">
                <flux:callout.heading icon="variable">{{ __('Flow start props') }}</flux:callout.heading>
        ...
        >
            ...
            <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">.../flow/flow-start.blade.php
            </flux:field>
        </flux:callout>
    </section>
