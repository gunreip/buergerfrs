                ...
                <flux:table.rows>
                    ...
                    <flux:table.row>
                        ...
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">Flow color inherited
                            from tw-graph unless the flow component overrides it.</flux:table.cell>
                    </flux:table.row>
                    <flux:table.row>
