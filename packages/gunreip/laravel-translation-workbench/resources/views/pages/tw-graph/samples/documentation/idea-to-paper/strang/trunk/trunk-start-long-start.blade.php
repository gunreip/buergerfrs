<section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
    <flux:callout color="indigo" icon="file-text" class="min-w-0">
        ...
        @php
            ...
            if (preg_match('/^[ \t]*\{\{-- trunk-start-long-start-example-1:start --\}\}\R(.*?)^[ \t]*\{\{-- trunk-start-long-start-example-1:end --\}\}/ms', $trunkExampleSource, $trunkExample1Match) !== 1) {
                throw new \LogicException('Missing trunk-start-long-start-example-1 source markers.');
            }
    ...
    <flux:callout color="zinc" icon="eye" class="min-w-0">
        ...
        <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">.../strang/trunk/trunk-start-long-start.blade.php</flux:field>
    </flux:callout>
</section>
