<section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
    ...
    >
        ...
        @php
            ...
            $docExample1Code = $docExampleSource->example('flow-switch-case-without-default-example-1');
            $docExample2Code = $docExampleSource->example('flow-switch-case-without-default-example-2');
        @endphp
        ...
        >
            ...
            <flux:table.rows>
                ...
                <flux:table.row>
                    ...
                    <flux:table.cell class="whitespace-normal">Action used when no case matches. Set :case-default="false" to omit DEFAULT and render a plain bypass without an action. Existing examples retain their configured DEFAULT.</flux:table.cell>
                </flux:table.row>
                <flux:table.row>
