<x-translation-workbench::ui.common.heading-counter-group group="strang-trunk-start-compare">
    <section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
        ...
        >
            ...
            <flux:callout.text>
                {{ __('The first example keeps trunk-start on its defaults. The second example changes only the trunk-start props: start length, centered start label, and left/right labels at the first anchor node.') }}
            </flux:callout.text>
            @php
                ...
                <flux:accordion.item expanded>
                    <flux:callout icon="code" color="indigo">
                        <x-translation-workbench::ui.common.heading-counter
                            example="trunk-start-compare-example-1"
                            variant="accordion"
                    ...
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $trunkExampleSource->example('trunk-start-compare-example-1') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
                <flux:accordion.item>
                    <flux:callout icon="code" color="indigo">
                        <x-translation-workbench::ui.common.heading-counter
                            example="trunk-start-compare-example-2"
                            variant="accordion"
                            :prefix-text="__('Complete example')"
                    ...
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $trunkExampleSource->example('trunk-start-compare-example-2') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
            </flux:accordion>
        ...
        <flux:callout class="min-w-0" color="emerald">
            ...
            <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">
                .../idea-to-paper/strang/trunk/trunk-start-compare.blade.php
            </flux:field>
        </flux:callout>
    </section>
