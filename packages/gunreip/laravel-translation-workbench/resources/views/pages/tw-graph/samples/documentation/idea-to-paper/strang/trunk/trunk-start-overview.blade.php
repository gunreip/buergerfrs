<section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
    <flux:callout color="indigo" icon="file-text" class="min-w-0">
        ...
        <x-translation-workbench::ui.tw-graph.documentation-links example="strang.trunk.trunk-start-overview" />
        ...
        @php
            ...
            $trunkExample1Code = $trunkExampleSource->example('trunk-start-overview-example-1');
            $trunkExample2Code = $trunkExampleSource->example('trunk-start-overview-example-2');
        @endphp
