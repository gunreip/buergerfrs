<section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
    ...
    >
        ...
        @php
            ...
            if (
                preg_match(
                    '/^[ \t]*\{\{-- trunk-default-example-1:start --\}\}\R(.*?)^[ \t]*\{\{-- trunk-default-example-1:end --\}\}/ms',
                    $trunkExampleSource,
                    $trunkExample1Match,
                ) !== 1
            ) {
                throw new \LogicException('Missing trunk-default-example-1 source markers.');
            }
    ...
    >
        ...
        <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">
            .../strang/trunk/trunk-default.blade.php</flux:field>
    </flux:callout>
</section>
