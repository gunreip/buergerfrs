                ...
                <flux:table.rows>
                    ...
                    <flux:table.row>
                        ...
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">Action executed when
                            the first condition is true. Its resolved color also colors the complete shared return stem.</flux:table.cell>
                    </flux:table.row>
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">elseifs</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">[]; one entry required</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">List with exactly one ELSEIF. Each entry supports conditionLabel, actionLabel, color, beforeLength and afterLength. Use flow-if-elseif-multi for multiple entries.</flux:table.cell>
                    </flux:table.row>
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">elseifs[].conditionLabel
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">ELSEIF condition?;
                            halfLong</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">Second decision,
                            reached only when the first condition is false.</flux:table.cell>
                    </flux:table.row>
                    <flux:table.row>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">elseifs[].actionLabel
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">ELSEIF action; half
                        </flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">Action executed only
                            when the first condition is false and the second is true.</flux:table.cell>
                    </flux:table.row>
                    <flux:table.row>
                    ...
                    <flux:table.row>
                        ...
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">2rem</flux:table.cell>
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">Line after the second
                            condition.</flux:table.cell>
                    </flux:table.row>
                    <flux:table.row>
                    ...
                    <flux:table.row>
                        ...
                        <flux:table.cell class="whitespace-normal break-words align-top text-xs">Override the canvas DEV
                            mode. Counters 1–6 identify the decisions, action outputs, bypass and common end.
                        </flux:table.cell>
                    </flux:table.row>
                    <flux:table.row>
