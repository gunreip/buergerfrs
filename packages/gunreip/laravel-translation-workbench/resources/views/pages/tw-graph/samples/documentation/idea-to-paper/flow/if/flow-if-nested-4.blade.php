    ...
    >
        ...
        @php
            $docExampleSource = \Gunreip\TranslationWorkbench\Support\TwGraph\Documentation\ExampleSource::fromView(
                'translation-workbench::pages.tw-graph.samples.documentation.idea-to-paper.flow.if.flow-if-nested-4',
            );
            $docExample1Code = $docExampleSource->example('flow-if-nested-4-example-1');
            $docExample2Code = $docExampleSource->example('flow-if-nested-4-example-2');
        @endphp
        <flux:heading
            class="mt-4"
            size="sm"
        ...
        >
            ...
            <flux:table.rows>
                ...
                <flux:table.row>
                    ...
                    <flux:table.cell class="whitespace-normal">Extends only the outgoing action bridge, separating the
                        nested input from the common output rail.</flux:table.cell>
                </flux:table.row>
                <flux:table.row>
                ...
                <flux:table.row>
                    ...
                    <flux:table.cell class="whitespace-normal">The last False route reserves 40rem here for the inner IF
                        and its return. No following ELSEIF exists to provide this space.</flux:table.cell>
                </flux:table.row>
                <flux:table.row>
                    ...
                    <flux:table.cell class="whitespace-normal">Entry for the inner IF when the last outer ELSEIF is
                        true.</flux:table.cell>
                </flux:table.row>
                <flux:table.row>
                    ...
                    <flux:table.cell class="whitespace-normal">Direct return target at the shared outer end, not at a
                        following ELSEIF action.</flux:table.cell>
                </flux:table.row>
                <flux:table.row>
                    ...
                    <flux:table.cell class="whitespace-normal">Continue after any successful outer action, completion of
                        the inner IF, or the outer fallback.</flux:table.cell>
                </flux:table.row>
                <flux:table.row>
    ...
    >
        ...
        >
            ...
            <div
                ...
                {{-- flow-if-nested-4-example-1:start --}}
                <x-translation-workbench::ui.tw-graph
                    graph-id="idea-to-paper-step-08-flow-if-nested-4"
                    :dev="true"
                    :coordinates="true"
                    color="cyan"
                    min-width="72rem"
                ...
                >
                    <x-translation-workbench::ui.tw-graph.strang.flow-start
                        id="literature.flow.1.if-nested-4-origin"
                        :start-label="['text' => ['Review request'], 'width' => 'half']"
                    />
                    {{-- Outer IF --}}
                    <x-translation-workbench::ui.tw-graph.strang.flow-if-elseif-multi
                        id="literature.flow.1.if-nested-4.outer"
                        attach-to="literature.flow.1.if-nested-4-origin.anchorNode-end"
                        side="left"
                        color="cyan"
                        ...
                        :elseifs="[
                            ...
                            [
                                ...
                                'actionLabel' => [
                                    ...
                                    'lineJumps' => [
                                        [
                                            'over' => 'literature.flow.1.if-nested-4.outer.elseif.sources.true.stem',
                                            'radius' => '0.65rem',
                                            'side' => 'top',
                                        ],
                                    ],
                    ...
                    <x-translation-workbench::ui.tw-graph.strang.flow-if-elseif-multi
                        id="literature.flow.1.if-nested-4.inner"
                        attach-to="literature.flow.1.if-nested-4.outer.elseif.deferred.true.anchorNode-end"
                        side="left"
                        color="amber"
                        before-length="2rem"
                    ...
                    @php
                        $nestedGraphId = 'idea-to-paper-step-08-flow-if-nested-4';
                        $innerEnd = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                            $nestedGraphId,
                            'literature.flow.1.if-nested-4.inner.anchorNode-end',
                        );
                        $outerReturn = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                            $nestedGraphId,
                            'literature.flow.1.if-nested-4.outer.elseif.deferred.true.anchorNode-return',
                        );
                    ...
                    @php
                        $returnEnd = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                            $nestedGraphId,
                            'literature.flow.1.if-nested-4.inner-return.anchorNode-end',
                        );
                    @endphp
                    <x-translation-workbench::ui.tw-graph.parts.start
                        id="literature.flow.1.if-nested-4.inner-return.stem"
                        return-to="literature.flow.1.if-nested-4.outer.elseif.deferred.true.anchorNode-return"
                    ...
                    <x-translation-workbench::ui.tw-graph.strang.flow-step
                        id="literature.flow.1.if-nested-4.continue"
                        attach-to="literature.flow.1.if-nested-4.outer.anchorNode-end"
                        color="fuchsia"
                    ...
                    @php
                        $outerInput = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                            $nestedGraphId,
                            'literature.flow.1.if-nested-4.outer.anchorNode-start',
                        );
                        $outerEnd = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                            $nestedGraphId,
                            'literature.flow.1.if-nested-4.outer.anchorNode-end',
                        );
                        $innerInput = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                            $nestedGraphId,
                            'literature.flow.1.if-nested-4.inner.anchorNode-start',
                        );
                    ...
                    <x-translation-workbench::ui.tw-graph.dev-box
                        id="literature.flow.1.if-nested-4.inner.bounds"
                    ...
                    />
                    <x-translation-workbench::ui.tw-graph.dev-box
                        id="literature.flow.1.if-nested-4.outer.bounds"
                ...
                {{-- flow-if-nested-4-example-1:end --}}
            </div>
            <flux:heading
                class="m-3"
                size="sm"
            ...
            <div
                class="mt-3 overflow-x-auto rounded-lg border border-zinc-200 bg-white/70 dark:border-zinc-700 dark:bg-zinc-900/40">
                {{-- flow-if-nested-4-example-2:start --}}
                <x-translation-workbench::ui.tw-graph
                    graph-id="idea-to-paper-step-08-flow-if-nested-4-right"
                    :dev="true"
                    :coordinates="true"
                    color="cyan"
                    min-width="72rem"
                ...
                >
                    <x-translation-workbench::ui.tw-graph.strang.flow-start
                        id="literature.flow.1.if-nested-4-right-origin"
                        :start-label="['text' => ['Review request'], 'width' => 'half']"
                    />
                    {{-- Outer IF --}}
                    <x-translation-workbench::ui.tw-graph.strang.flow-if-elseif-multi
                        id="literature.flow.1.if-nested-4-right.outer"
                        attach-to="literature.flow.1.if-nested-4-right-origin.anchorNode-end"
                        side="right"
                        color="cyan"
                        :condition-label="['text' => ['IF review required?'], 'width' => 'halfLong']"
                        :if-start="[
                            ...
                            [
                                ...
                                'actionLabel' => [
                                    ...
                                    'stemLineJumps' => [
                                        [
                                            'over' =>
                                                'literature.flow.1.if-nested-4-right.outer.elseif.deferred.true.bridge1.bridge-out',
                                            'radius' => '0.65rem',
                                            'side' => 'right',
                                        ],
                                    ],
                    ...
                    {{-- The inner block is entered only when the last outer ELSEIF is true. --}}
                    <x-translation-workbench::ui.tw-graph.strang.flow-if-elseif-multi
                        id="literature.flow.1.if-nested-4-right.inner"
                        attach-to="literature.flow.1.if-nested-4-right.outer.elseif.deferred.true.anchorNode-end"
                        side="right"
                        color="amber"
                        before-length="2rem"
                        :condition-label="['text' => ['IF result is green?'], 'width' => 'halfLong', 'align' => 'left']"
                    ...
                    {{-- Return above the inner block, then join the outer output rail. --}}
                    @php
                        $nestedGraphId = 'idea-to-paper-step-08-flow-if-nested-4-right';
                        $innerEnd = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                            $nestedGraphId,
                            'literature.flow.1.if-nested-4-right.inner.anchorNode-end',
                        );
                        $outerReturn = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                            $nestedGraphId,
                            'literature.flow.1.if-nested-4-right.outer.elseif.deferred.true.anchorNode-return',
                        );
                    ...
                    @php
                        $returnEnd = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                            $nestedGraphId,
                            'literature.flow.1.if-nested-4-right.inner-return.anchorNode-end',
                        );
                    @endphp
                    <x-translation-workbench::ui.tw-graph.parts.start
                        id="literature.flow.1.if-nested-4-right.inner-return.stem"
                        return-to="literature.flow.1.if-nested-4-right.outer.elseif.deferred.true.anchorNode-return"
                        :anchor-start="$returnEnd"
                        :length="'calc(' . $outerReturn['y'] . ' - ' . $returnEnd['y'] . ')'"
                        :gradient="false"
                        :node-end="false"
                    ...
                    />
                    <x-translation-workbench::ui.tw-graph.strang.flow-step
                        id="literature.flow.1.if-nested-4-right.continue"
                        attach-to="literature.flow.1.if-nested-4-right.outer.anchorNode-end"
                        color="fuchsia"
                        :step-label="['text' => ['Continue process'], 'width' => 'halfLong']"
                    />
                    @php
                        $outerInput = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                            $nestedGraphId,
                            'literature.flow.1.if-nested-4-right.outer.anchorNode-start',
                        );
                        $outerEnd = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                            $nestedGraphId,
                            'literature.flow.1.if-nested-4-right.outer.anchorNode-end',
                        );
                        $innerInput = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                            $nestedGraphId,
                            'literature.flow.1.if-nested-4-right.inner.anchorNode-start',
                        );
                        $innerBounds = \Gunreip\TranslationWorkbench\Support\TwGraphProtocol\GeometryBounds::fromPoints(
                            [$innerInput, $innerEnd],
                            '10rem',
                    ...
                    @endphp
                    <x-translation-workbench::ui.tw-graph.dev-box
                        id="literature.flow.1.if-nested-4-right.inner.bounds"
                        label="Inner IF / ELSEIF / ELSE"
                        :x="$innerBounds['left']"
                        :y="$innerBounds['bottom']"
                        :width="$innerBounds['width']"
                    ...
                    />
                    <x-translation-workbench::ui.tw-graph.dev-box
                        id="literature.flow.1.if-nested-4-right.outer.bounds"
                        label="Outer IF including nested section"
                        :x="$outerBounds['left']"
                        :y="$outerBounds['bottom']"
                        :width="$outerBounds['width']"
                ...
                {{-- flow-if-nested-4-example-2:end --}}
            </div>
        </x-translation-workbench::ui.tw-graph.preview-tools>
        <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">.../flow/if/flow-if-nested-4.blade.php
        </flux:field>
    </flux:callout>
</section>
