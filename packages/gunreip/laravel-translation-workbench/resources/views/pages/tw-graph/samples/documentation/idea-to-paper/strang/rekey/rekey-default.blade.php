<x-translation-workbench::ui.common.heading-counter-group group="strang-rekey-default">
    <section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
        <flux:callout
            ...
            icon="file-text"
        >
            <flux:callout.heading>{{ __('Rekey default') }}</flux:callout.heading>
            <x-translation-workbench::ui.tw-graph.documentation-links example="strang.rekey.rekey-default" />
            ...
            @php
                $docExampleSource = \Gunreip\TranslationWorkbench\Support\TwGraph\Documentation\ExampleSource::fromView(
                    'translation-workbench::pages.tw-graph.samples.documentation.idea-to-paper.strang.rekey.rekey-default',
                );
            @endphp
                ...
                <flux:accordion.item expanded>
                    <flux:callout icon="code" color="indigo">
                        <x-translation-workbench::ui.common.heading-counter
                            example="rekey-default-example-1"
                            variant="accordion"
                            :prefix-text="__('Complete example')"
                        >{{ __('Rekey default') }}</x-translation-workbench::ui.common.heading-counter>
                    </flux:callout>
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $docExampleSource->example('rekey-default-example-1') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
            </flux:accordion>
            <flux:separator class="mt-4" :text="__('Props used in these examples')" />
            <flux:callout color="indigo">
                <flux:callout.heading icon="variable">{{ __('Rekey default props') }}</flux:callout.heading>
                ...
                <div class="mt-4 grid min-w-0 gap-4">
                    <div class="min-w-0">
                        ...
                        <div class="mt-3 overflow-x-auto rounded-lg border border-zinc-200 bg-white/70 dark:border-zinc-700 dark:bg-zinc-900/40">
                            {{-- rekey-default-example-1:start --}}
                            <x-translation-workbench::ui.tw-graph
                                graph-id="idea-to-paper-step-07-rekey"
                                :dev="true"
                                :coordinates="true"
                                color="violet"
                                line-length="4rem"
                            ...
                            {{-- rekey-default-example-1:end --}}
                        </div>
                    </div>
                </div>
            </x-translation-workbench::ui.tw-graph.preview-tools>
            <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">
                .../idea-to-paper/strang/rekey/rekey-default.blade.php
            </flux:field>
        </flux:callout>
    </section>
