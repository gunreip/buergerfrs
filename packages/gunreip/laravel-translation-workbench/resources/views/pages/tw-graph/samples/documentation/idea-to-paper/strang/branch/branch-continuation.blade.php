<x-translation-workbench::ui.common.heading-counter-group group="strang-branch-continuation">
    <section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
        ...
        >
            ...
            <x-translation-workbench::ui.tw-graph.documentation-links example="strang.branch.branch-continuation" />
                ...
                <flux:accordion.item expanded>
                    ...
                    >
                        <x-translation-workbench::ui.common.heading-counter
                            example="branch-continuation-example-1"
                            variant="accordion"
                            :prefix-text="__('Complete example')"
                        >{{ __('Branch continuation') }}</x-translation-workbench::ui.common.heading-counter>
                    </flux:callout>
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $docExampleSource->example('branch-continuation-example-1') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
            </flux:accordion>
            <flux:separator
            ...
            <flux:callout color="indigo">
                <flux:callout.heading icon="variable">{{ __('Branch continuation props') }}</flux:callout.heading>
        ...
        >
            ...
            <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">
                .../idea-to-paper/strang/branch/branch-continuation.blade.php
            </flux:field>
        </flux:callout>
    </section>
