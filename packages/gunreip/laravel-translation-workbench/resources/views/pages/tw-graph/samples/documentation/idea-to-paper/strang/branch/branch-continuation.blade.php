<section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
    ...
    >
        ...
        @php
            ...
            if (
                preg_match(
                    '/^[ \t]*\{\{-- branch-continuation-example-1:start --\}\}\R(.*?)^[ \t]*\{\{-- branch-continuation-example-1:end --\}\}/ms',
                    $docExampleSource,
                    $docExample1Match,
                ) !== 1
            ) {
                throw new \LogicException('Missing branch-continuation-example-1 source markers.');
            }
