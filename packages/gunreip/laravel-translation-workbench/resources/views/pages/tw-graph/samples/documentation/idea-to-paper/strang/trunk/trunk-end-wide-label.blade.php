<x-translation-workbench::ui.common.heading-counter-group group="strang-trunk-end-wide-label">
    <section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
        <flux:callout
            ...
            icon="file-text"
        >
            <flux:callout.heading>{{ __('End wide label') }}</flux:callout.heading>
            <x-translation-workbench::ui.tw-graph.documentation-links example="strang.trunk.trunk-end-wide-label" />
            ...
            @php
                $trunkExampleSource = \Gunreip\TranslationWorkbench\Support\TwGraph\Documentation\ExampleSource::fromView(
                    'translation-workbench::pages.tw-graph.samples.documentation.idea-to-paper.strang.trunk.trunk-end-wide-label',
                );
            @endphp
            <flux:separator
                class="mt-4"
                ...
                <flux:accordion.item expanded>
                    ...
                    >
                        <x-translation-workbench::ui.common.heading-counter
                            example="trunk-end-wide-label-example-1"
                            variant="accordion"
                            :prefix-text="__('Complete example')"
                        >{{ __('End wide label') }}</x-translation-workbench::ui.common.heading-counter>
                    </flux:callout>
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $trunkExampleSource->example('trunk-end-wide-label-example-1') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
            </flux:accordion>
            <flux:separator
                ...
                <div class="mt-4 grid min-w-0 gap-4">
                    <div class="min-w-0">
                        ...
                        <div
                            ...
                            {{-- trunk-end-wide-label-example-1:start --}}
                            ...
                            {{-- trunk-end-wide-label-example-1:end --}}
                        </div>
                    </div>
                </div>
            </x-translation-workbench::ui.tw-graph.preview-tools>
            <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">
                .../idea-to-paper/strang/trunk/trunk-end-wide-label.blade.php
            </flux:field>
        </flux:callout>
    </section>
