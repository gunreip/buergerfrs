@php
    $canvasSource = \Gunreip\TranslationWorkbench\Support\TwGraph\Documentation\ExampleSource::fromView(
        'translation-workbench::pages.tw-graph.samples.documentation.idea-to-paper.canvas.canvas-props-min-width',
    );
@endphp
    ...
    >
        ...
        >
            <flux:accordion.item expanded>
                ...
                >
                    <flux:accordion.heading>
                        {{ __('Min width · default') }}
                    </flux:accordion.heading>
                </flux:callout>
                <flux:accordion.content>
                    <x-translation-workbench::ui.tw-graph.code-box>{{ $canvasSource->example('canvas-props-min-width-1') }}</x-translation-workbench::ui.tw-graph.code-box>
                </flux:accordion.content>
            </flux:accordion.item>
            ...
            <flux:accordion.item>
                ...
                <flux:accordion.content>
                    <x-translation-workbench::ui.tw-graph.code-box>{{ $canvasSource->example('canvas-props-min-width-2') }}</x-translation-workbench::ui.tw-graph.code-box>
                </flux:accordion.content>
            </flux:accordion.item>
        </flux:accordion>
