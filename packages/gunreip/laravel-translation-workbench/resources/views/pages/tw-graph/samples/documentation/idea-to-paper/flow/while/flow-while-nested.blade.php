<section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
    <flux:callout
        ...
        icon="file-text"
    >
        <flux:callout.heading>Nested WHILE</flux:callout.heading>
        <flux:callout.text>Initialize the group index once. Each outer iteration selects a group and resets its item
            ...
            an empty group list skips both bodies. All spacing and both return targets are explicitly authored below.
        </flux:callout.text>
        @php
    ...
    <flux:callout
        ...
        icon="eye"
    >
        <flux:callout.heading>Nested WHILE · left / right</flux:callout.heading>
