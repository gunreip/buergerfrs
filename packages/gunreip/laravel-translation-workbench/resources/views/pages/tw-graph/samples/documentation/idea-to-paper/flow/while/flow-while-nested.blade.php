<x-translation-workbench::ui.common.heading-counter-group group="flow-while-nested">
    <section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
        <flux:callout
            ...
            icon="file-text"
        >
            <flux:callout.heading>{{ __('Nested WHILE') }}</flux:callout.heading>
            <flux:callout.text>{{ __('Initialize the group index once. Each outer iteration selects a group and resets its item index. The inner WHILE processes that group\'s items and advances only the item index. Its FALSE exit advances the group index, then returns to the outer condition. An empty group skips the inner body; an empty group list skips both bodies. All spacing and both return targets are explicitly authored below.') }}</flux:callout.text>
            @php
                $whileSource = \Gunreip\TranslationWorkbench\Support\TwGraph\Documentation\ExampleSource::fromView(
                    'translation-workbench::pages.tw-graph.samples.documentation.idea-to-paper.flow.while.flow-while-nested',
                );
            @endphp
                ...
                <flux:accordion.item expanded>
                    <flux:callout icon="code" color="indigo">
                        <x-translation-workbench::ui.common.heading-counter
                            example="while-nested-left-example"
                            variant="accordion"
                    ...
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $whileSource->example('while-nested-left-example') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
                <flux:accordion.item>
                    <flux:callout icon="code" color="indigo">
                        <x-translation-workbench::ui.common.heading-counter
                            example="while-nested-right-example"
                            variant="accordion"
                            :prefix-text="__('Complete example')"
                    ...
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $whileSource->example('while-nested-right-example') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
            </flux:accordion>

            <x-translation-workbench::ui.tw-graph.documentation-links example="flow.while.flow-while-nested" />
                    ...
                    <flux:table container:class="max-h-80">
                        ...
                        <flux:table.rows>
                            ...
                            <flux:table.row>
                                ...
                                <flux:table.cell class="wrap-break-word whitespace-normal align-top">
                                    {{ __('Two segments.arc using the canvas radius (default 2.75rem) turn inner FALSE into a horizontal flow-step, then downward into the outer return. Its label-gap of 16rem sets the horizontal separation; both arc endpoint calculations are visible in the example.') }}
                                </flux:table.cell>
                            </flux:table.row>
                            <flux:table.row>
                                <flux:table.cell class="wrap-break-word whitespace-normal align-top">
            ...
            <x-translation-workbench::ui.tw-graph.language-examples
                source-view="translation-workbench::pages.tw-graph.samples.documentation.idea-to-paper.flow.while.flow-while-nested"
        ...
        <flux:callout
            ...
            color="emerald"
        >
            <flux:callout.heading icon="eye">{{ __('Nested WHILE · left / right') }}</flux:callout.heading>
            ...
            >
                ...
                <div
                    ...
                    {{-- while-nested-left-example:start --}}
                    <x-translation-workbench::ui.tw-graph
                        graph-id="idea-to-paper-while-nested-left"
                        :dev="true"
                        :coordinates="true"
                    ...
                    >
                        ...
                        <x-translation-workbench::ui.tw-graph.strang.flow-step
                            id="literature.while.nested.left.initialize"
                        ...
                        <x-translation-workbench::ui.tw-graph.strang.flow-while
                            id="literature.while.nested.left.loop"
                            :counter-start="1"
                            attach-to="literature.while.nested.left.initialize.anchorNode-end"
                            side="left"
                            color="cyan"
                            ...
                            :action-label="[
                                ...
                                'afterLength' => '16rem',
                                'lineJumps' => [
                                    ['over' => 'literature.while.nested.left.body-return.stem', 'radius' => '0.65rem', 'side' =>
                                        'top'
                                    ],
                                ],
                        ...
                        @php
                            $leftOuterBodyEnd = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                                'idea-to-paper-while-nested-left',
                                'literature.while.nested.left.loop.body.anchorNode-end',
                            );
                            $leftInnerStart = [
                        ...
                        <x-translation-workbench::ui.tw-graph.paths.loop-return
                            id="literature.while.nested.left.inner-entry"
                            :counter-start="7"
                            attach-to="literature.while.nested.left.loop.body.anchorNode-end"
                        ...
                        <x-translation-workbench::ui.tw-graph.strang.flow-while
                            id="literature.while.nested.left.inner-loop"
                            :counter-start="11"
                        ...
                        <x-translation-workbench::ui.tw-graph.strang.flow-step
                            id="literature.while.nested.left.inner-advance"
                            :counter-end="17"
                            attach-to="literature.while.nested.left.inner-loop.body.anchorNode-end"
                        ...
                        />
                        <x-translation-workbench::ui.tw-graph.paths.loop-return
                            id="literature.while.nested.left.inner-return"
                            :counter-start="18"
                            attach-to="literature.while.nested.left.inner-advance.anchorNode-end"
                            return-to="literature.while.nested.left.inner-loop.anchorNode-return"
                            side="left"
                            color="sky"
                        />
                        ...
                        @php
                            $leftInnerExit = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                                'idea-to-paper-while-nested-left',
                                'literature.while.nested.left.inner-loop.anchorNode-end',
                            );
                        ...
                        <x-translation-workbench::ui.tw-graph.segments.arc :segment="[
                            'id' => 'literature.while.nested.left.outer-resume.arc-in',
                            'devCounterEnd' => 22,
                        ...
                        <x-translation-workbench::ui.tw-graph.strang.flow-step
                            id="literature.while.nested.left.advance"
                            :counter-end="23"
                        ...
                        @php
                            $leftAdvanceEnd = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                                'idea-to-paper-while-nested-left',
                                'literature.while.nested.left.advance.anchorNode-end',
                            );
                        ...
                        @endphp
                        <x-translation-workbench::ui.tw-graph.segments.arc :segment="[
                            'id' => 'literature.while.nested.left.outer-resume.arc-out',
                            'devCounterEnd' => 24,
                        ...
                        <x-translation-workbench::ui.tw-graph.paths.loop-return
                            id="literature.while.nested.left.body-return"
                            :counter-start="25"
                            :anchor-start="$leftOuterReturnStart"
                            return-to="literature.while.nested.left.loop.anchorNode-return"
                            side="left"
                            color="cyan"
                        />
                        {{-- FALSE continues here, including when the group list starts empty. --}}
                        <x-translation-workbench::ui.tw-graph.strang.flow-step
                            id="literature.while.nested.left.continue"
                            :counter-end="29"
                            attach-to="literature.while.nested.left.loop.anchorNode-end"
                            beforeLength="4rem"
                            :step-label="['text' => ['Show summary'], 'width' => 'default']"
                            color="violet"
                        />
                    </x-translation-workbench::ui.tw-graph>
                    {{-- while-nested-left-example:end --}}
                </div>
                <x-translation-workbench::ui.common.heading-counter
                    example="while-nested-right-example"
                    size="sm"
                ...
                <div
                    class="mt-3 overflow-x-auto rounded-lg border border-zinc-200 bg-white/70 dark:border-zinc-700 dark:bg-zinc-900/40">
                    {{-- while-nested-right-example:start --}}
                    <x-translation-workbench::ui.tw-graph
                        graph-id="idea-to-paper-while-nested-right"
                        :dev="true"
                        :coordinates="true"
                        horizontalPadding="6rem"
                        min-height="46rem"
                    ...
                    >
                        {{-- Initialization runs once. --}}
                        <x-translation-workbench::ui.tw-graph.strang.flow-step
                            id="literature.while.nested.right.initialize"
                            :anchor-start="['x' => '0rem', 'y' => '2rem']"
                            :step-label="['text' => ['Load groups', 'groupIndex = 0'], 'width' => 'default']"
                            afterLength="5rem"
                            color="zinc"
                        ...
                        {{-- Each outer iteration selects a group and resets its inner index. --}}
                        <x-translation-workbench::ui.tw-graph.strang.flow-while
                            id="literature.while.nested.right.loop"
                            :counter-start="1"
                            attach-to="literature.while.nested.right.initialize.anchorNode-end"
                            side="right"
                            color="cyan"
                            true-bridge-length="4rem"
                            stem-length="3.5rem"
                            ...
                            :action-label="[
                                ...
                                'afterLength' => '16rem',
                                'lineJumps' => [
                                    ['over' => 'literature.while.nested.right.body-return.stem', 'radius' => '0.65rem', 'side' =>
                                        'top'
                                    ],
                                ],
                                'text' => ['Select group', 'itemIndex = 0'],
                        ...
                        @php
                            $rightOuterBodyEnd = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                                'idea-to-paper-while-nested-right',
                                'literature.while.nested.right.loop.body.anchorNode-end',
                            );
                            $rightInnerStart = [
                        ...
                        @endphp
                        <x-translation-workbench::ui.tw-graph.paths.loop-return
                            id="literature.while.nested.right.inner-entry"
                            :counter-start="7"
                            attach-to="literature.while.nested.right.loop.body.anchorNode-end"
                        ...
                        {{-- The inner return skips initialization, so itemIndex is not reset on every item. --}}
                        <x-translation-workbench::ui.tw-graph.strang.flow-while
                            id="literature.while.nested.right.inner-loop"
                            :counter-start="11"
                        ...
                        {{-- Advance only the inner index, then recheck the inner condition. --}}
                        <x-translation-workbench::ui.tw-graph.strang.flow-step
                            id="literature.while.nested.right.inner-advance"
                            :counter-end="17"
                            attach-to="literature.while.nested.right.inner-loop.body.anchorNode-end"
                            direction="top-bottom"
                            before-length="2rem"
                            label-gap="4rem"
                            after-length="2rem"
                        ...
                        />
                        <x-translation-workbench::ui.tw-graph.paths.loop-return
                            id="literature.while.nested.right.inner-return"
                            :counter-start="18"
                            attach-to="literature.while.nested.right.inner-advance.anchorNode-end"
                            return-to="literature.while.nested.right.inner-loop.anchorNode-return"
                            side="right"
                            color="sky"
                        />
                        {{-- Turn inner FALSE toward the separate outer return lane. --}}
                        @php
                            $rightInnerExit = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                                'idea-to-paper-while-nested-right',
                                'literature.while.nested.right.inner-loop.anchorNode-end',
                            );
                        ...
                        @endphp
                        <x-translation-workbench::ui.tw-graph.segments.arc :segment="[
                            'id' => 'literature.while.nested.right.outer-resume.arc-in',
                            'devCounterEnd' => 22,
                        ...
                        {{-- Only inner FALSE advances the group index, including for an empty group. --}}
                        <x-translation-workbench::ui.tw-graph.strang.flow-step
                            id="literature.while.nested.right.advance"
                            :counter-end="23"
                        ...
                        @php
                            $rightAdvanceEnd = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                                'idea-to-paper-while-nested-right',
                                'literature.while.nested.right.advance.anchorNode-end',
                            );
                        ...
                        @endphp
                        <x-translation-workbench::ui.tw-graph.segments.arc :segment="[
                            'id' => 'literature.while.nested.right.outer-resume.arc-out',
                            'devCounterEnd' => 24,
                        ...
                        {{-- Return only after advancing, to the same condition (not initialization). --}}
                        <x-translation-workbench::ui.tw-graph.paths.loop-return
                            id="literature.while.nested.right.body-return"
                            :counter-start="25"
                            :anchor-start="$rightOuterReturnStart"
                            return-to="literature.while.nested.right.loop.anchorNode-return"
                            side="right"
                            color="cyan"
                        />
                        {{-- FALSE continues here, including when the group list starts empty. --}}
                        <x-translation-workbench::ui.tw-graph.strang.flow-step
                            id="literature.while.nested.right.continue"
                            :counter-end="29"
                            attach-to="literature.while.nested.right.loop.anchorNode-end"
                            beforeLength="4rem"
                            :step-label="['text' => ['Show summary'], 'width' => 'default']"
                            color="violet"
                        />
                    </x-translation-workbench::ui.tw-graph>
                    {{-- while-nested-right-example:end --}}
                </div>
            </x-translation-workbench::ui.tw-graph.preview-tools>
            <flux:field class="mt-3 flex justify-end font-mono text-xs text-zinc-400">
                .../flow/while/flow-while-nested.blade.php
            </flux:field>
        </flux:callout>
    </section>
