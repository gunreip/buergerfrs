<x-translation-workbench::ui.common.heading-counter-group group="flow-if-elseif-multi">
                ...
                <flux:accordion.item expanded>
                    ...
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $docExampleSource->example('flow-if-elseif-multi-example-1') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
                <flux:accordion.item>
                    <flux:callout icon="code" color="indigo">
                    ...
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $docExampleSource->example('flow-if-elseif-multi-example-2') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
            </flux:accordion>
                    ...
                    <flux:table container:class="max-h-80">
                        ...
                        <flux:table.rows>
                            ...
                            <flux:table.row>
                                ...
                                <flux:table.cell class="wrap-break-word whitespace-normal align-top">
                                    <code>required, at least one entry</code>
                                </flux:table.cell>
                                <flux:table.cell class="wrap-break-word whitespace-normal align-top">
                                    {{ __('Ordered branch definitions: key (unique; defaults to position), conditionLabel, actionLabel, color, beforeLength and afterLength. conditionLabel.color sets the branch color; actionLabel.color overrides the action route. The incoming question stem retains the preceding anchor color. badgeColor remains independent. Branch IDs use .elseif.KEY.') }}
                                </flux:table.cell>
                            </flux:table.row>
                            <flux:table.row>
                                <flux:table.cell class="wrap-break-word whitespace-normal align-top">
                            ...
                            <flux:table.row>
                                ...
                                <flux:table.cell class="wrap-break-word whitespace-normal align-top">
                                    {{ __('Default line after each ELSEIF condition; branch afterLength overrides it.') }}
                                </flux:table.cell>
                            </flux:table.row>
                            <flux:table.row>
                                <flux:table.cell class="wrap-break-word whitespace-normal align-top">
