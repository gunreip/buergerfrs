<section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
    ...
    >
        ...
        @php
            ...
            $docExample1Code = $docExampleSource->example('flow-switch-case-nested-1-example-1');
            $docExample2Code = $docExampleSource->example('flow-switch-case-nested-1-example-2');
        @endphp
        <flux:heading
            class="mt-3"
            size="sm"
        >Outer side="left" · Inner side="left"</flux:heading>
        <x-translation-workbench::ui.tw-graph.code-box
            class="mt-3">{{ $docExample1Code }}</x-translation-workbench::ui.tw-graph.code-box>
        <flux:heading class="mt-4" size="sm">Outer side="left" · Inner side="right"</flux:heading>
