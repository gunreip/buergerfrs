<x-translation-workbench::ui.common.heading-counter-group group="flow-switch-case-nested-1">
    <section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
        <flux:callout
            ...
            icon="file-text"
        >
            <flux:callout.heading>{{ __('CASE SWITCH CASE (1)') }}</flux:callout.heading>
            <x-translation-workbench::ui.tw-graph.documentation-links example="flow.switch-case.flow-switch-case-nested-1" />
            <flux:callout.text>
            ...
            @php
                $docExampleSource = \Gunreip\TranslationWorkbench\Support\TwGraph\Documentation\ExampleSource::fromView(
                    'translation-workbench::pages.tw-graph.samples.documentation.idea-to-paper.flow.switch-case.flow-switch-case-nested-1',
                );
            @endphp
                ...
                <flux:accordion.item expanded>
                    <flux:callout icon="code" color="indigo">
                        <x-translation-workbench::ui.common.heading-counter
                            example="flow-switch-case-nested-1-example-1"
                            variant="accordion"
                            :prefix-text="__('Complete example')"
                        >{{ __('Outer side="left" · Inner side="left"') }}</x-translation-workbench::ui.common.heading-counter>
                    </flux:callout>
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $docExampleSource->example('flow-switch-case-nested-1-example-1') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
                <flux:accordion.item>
                    <flux:callout icon="code" color="indigo">
                        <x-translation-workbench::ui.common.heading-counter
                            example="flow-switch-case-nested-1-example-2"
                            variant="accordion"
                            :prefix-text="__('Complete example')"
                        >{{ __('Outer side="left" · Inner side="right"') }}</x-translation-workbench::ui.common.heading-counter>
                    </flux:callout>
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $docExampleSource->example('flow-switch-case-nested-1-example-2') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
            </flux:accordion>
            ...
            <x-translation-workbench::ui.tw-graph.language-examples
                source-view="translation-workbench::pages.tw-graph.samples.documentation.idea-to-paper.flow.switch-case.flow-switch-case-nested-1"
        ...
        >
            ...
            >
                ...
                <div
                    ...
                    {{-- flow-switch-case-nested-1-example-1:start --}}
                    <x-translation-workbench::ui.tw-graph
                        graph-id="idea-to-paper-flow-switch-case-nested-1"
                        :dev="true"
                        :coordinates="true"
                        color="cyan"
                        min-width="86rem"
                    ...
                    >
                        <x-translation-workbench::ui.tw-graph.strang.flow-start
                            id="literature.switch.1.grouped-nested-1.start"
                        ...
                        <x-translation-workbench::ui.tw-graph.strang.flow-switch-case
                            id="literature.switch.1.grouped-nested-1.outer"
                            attach-to="literature.switch.1.grouped-nested-1.start.anchorNode-end"
                            side="left"
                            stem-length="3rem"
                            color="cyan"
                            :case-expression="[
                        ...
                        <x-translation-workbench::ui.tw-graph.strang.flow-switch-case
                            id="literature.switch.1.grouped-nested-1.inner"
                            attach-to="literature.switch.1.grouped-nested-1.outer.case.editable.anchorNode-end"
                            side="left"
                            stem-length="2rem"
                            color="amber"
                            :case-expression="[
                        ...
                        @php
                            $nestedGraphId = 'idea-to-paper-flow-switch-case-nested-1';
                            $innerEnd = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                                $nestedGraphId,
                                'literature.switch.1.grouped-nested-1.inner.anchorNode-end',
                            );
                            $outerReturn = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                                $nestedGraphId,
                                'literature.switch.1.grouped-nested-1.outer.case.editable.anchorNode-return',
                            );
                        ...
                        @php
                            $returnEnd = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                                $nestedGraphId,
                                'literature.switch.1.grouped-nested-1.inner-return.anchorNode-end',
                            );
                        @endphp
                        <x-translation-workbench::ui.tw-graph.parts.start
                            id="literature.switch.1.grouped-nested-1.inner-return.stem"
                            :anchor-start="$returnEnd"
                            return-to="literature.switch.1.grouped-nested-1.outer.case.editable.anchorNode-return"
                        ...
                        <x-translation-workbench::ui.tw-graph.strang.flow-step
                            id="literature.switch.1.grouped-nested-1.continue"
                            attach-to="literature.switch.1.grouped-nested-1.outer.anchorNode-end"
                            color="fuchsia"
                            :step-label="['text' => ['Continue process'], 'width' => 'default']"
                        />
                    </x-translation-workbench::ui.tw-graph>
                    {{-- flow-switch-case-nested-1-example-1:end --}}
                </div>
                <x-translation-workbench::ui.common.heading-counter
                    example="flow-switch-case-nested-1-example-2"
                    size="sm"
                ...
                <div
                    class="mt-3 overflow-x-auto rounded-lg border border-zinc-200 bg-white/70 dark:border-zinc-700 dark:bg-zinc-900/40">
                    {{-- flow-switch-case-nested-1-example-2:start --}}
                    <x-translation-workbench::ui.tw-graph
                        graph-id="idea-to-paper-flow-switch-case-nested-1-inner-right"
                        :dev="true"
                        :coordinates="true"
                        color="cyan"
                        min-width="86rem"
                    ...
                    >
                        <x-translation-workbench::ui.tw-graph.strang.flow-start
                            id="literature.switch.1.grouped-nested-1-inner-right.start"
                            :start-label="['text' => ['Article request'], 'width' => 'default']"
                        />

                        {{-- Outer SWITCH: three CASE entries fuse before the shared action and inner SWITCH. --}}
                        <x-translation-workbench::ui.tw-graph.strang.flow-switch-case
                            id="literature.switch.1.grouped-nested-1-inner-right.outer"
                            attach-to="literature.switch.1.grouped-nested-1-inner-right.start.anchorNode-end"
                            side="left"
                            bridge-length="8rem"
                            stem-length="3rem"
                            color="cyan"
                        ...
                        {{-- Inner SWITCH: choose an editor from the article format. --}}
                        <x-translation-workbench::ui.tw-graph.strang.flow-switch-case
                            id="literature.switch.1.grouped-nested-1-inner-right.inner"
                            attach-to="literature.switch.1.grouped-nested-1-inner-right.outer.case.editable.anchorNode-end"
                            side="right"
                            stem-length="2rem"
                            color="amber"
                            :case-expression="[
                        ...
                        {{-- Return above the inner SWITCH to the outer CASE output rail. --}}
                        @php
                            $nestedGraphId = 'idea-to-paper-flow-switch-case-nested-1-inner-right';
                            $innerEnd = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                                $nestedGraphId,
                                'literature.switch.1.grouped-nested-1-inner-right.inner.anchorNode-end',
                            );
                            $outerReturn = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                                $nestedGraphId,
                                'literature.switch.1.grouped-nested-1-inner-right.outer.case.editable.anchorNode-return',
                            );
                        ...
                        @php
                            $returnEnd = \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::get(
                                $nestedGraphId,
                                'literature.switch.1.grouped-nested-1-inner-right.inner-return.anchorNode-end',
                            );
                        @endphp
                        <x-translation-workbench::ui.tw-graph.parts.start
                            id="literature.switch.1.grouped-nested-1-inner-right.inner-return.stem"
                            :anchor-start="$returnEnd"
                            return-to="literature.switch.1.grouped-nested-1-inner-right.outer.case.editable.anchorNode-return"
                            :length="'calc(' . $outerReturn['y'] . ' - ' . $returnEnd['y'] . ')'"
                            :gradient="false"
                            :node-end="false"
                            :dev-counter-end="false"
                        ...
                        />
                        <x-translation-workbench::ui.tw-graph.strang.flow-step
                            id="literature.switch.1.grouped-nested-1-inner-right.continue"
                            attach-to="literature.switch.1.grouped-nested-1-inner-right.outer.anchorNode-end"
                            color="fuchsia"
                            :step-label="['text' => ['Continue process'], 'width' => 'default']"
                        />
                    </x-translation-workbench::ui.tw-graph>
                    {{-- flow-switch-case-nested-1-example-2:end --}}
                </div>
            </x-translation-workbench::ui.tw-graph.preview-tools>
            <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">
                .../flow/switch-case/flow-switch-case-nested-1.blade.php
            </flux:field>
        </flux:callout>
    </section>
