<x-translation-workbench::ui.common.heading-counter-group group="flow-while-mixed">
                    ...
                    <flux:table container:class="max-h-80">
                        ...
                        <flux:table.rows>
                            ...
                            <flux:table.row>
                                ...
                                <flux:table.cell class="wrap-break-word whitespace-normal align-top">
                                    {{ __('Bridge after the body action: 40rem outside reserves the separate return lane and its crossing; 2rem inside.') }}
                                </flux:table.cell>
                            </flux:table.row>
                            <flux:table.row>
                                <flux:table.cell class="wrap-break-word whitespace-normal align-top">
                            ...
                            <flux:table.row>
                                ...
                                <flux:table.cell class="wrap-break-word whitespace-normal align-top">
                                    {{ __('Outer body: inner-entry turns toward the inner WHILE on the opposite side. Inner body: the downward item increment uses before-length="6rem" to clear the outer bridge.') }}
                                </flux:table.cell>
                            </flux:table.row>
                            <flux:table.row>
                                <flux:table.cell class="wrap-break-word whitespace-normal align-top">
                            ...
                            <flux:table.row>
                                ...
                                <flux:table.cell class="wrap-break-word whitespace-normal align-top">
                                    {{ __('The outer action\'s outgoing bridge jumps over inner-loop.condition.stem.after and inner-advance.stem.before. Neither crossing is a connection.') }}
                                </flux:table.cell>
                            </flux:table.row>
                            <flux:table.row>
                                <flux:table.cell class="wrap-break-word whitespace-normal align-top">
