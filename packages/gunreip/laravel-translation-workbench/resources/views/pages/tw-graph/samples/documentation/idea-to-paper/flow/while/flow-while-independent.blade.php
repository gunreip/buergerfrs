<section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
    <flux:callout
        ...
        icon="file-text"
    >
        <flux:callout.heading>Two independent inner loops</flux:callout.heading>
        <flux:callout.text>Each group first processes its items, then sends its notifications. The two inner WHILE
            loops have independent indices and return targets. The first FALSE exit initializes the notification index;
            the second FALSE exit advances the group index. An empty item list still allows notifications to run, and
            an empty notification list still advances the group. Both initializations stay outside their own returns.
        </flux:callout.text>
        @php
            ...
            <flux:table.rows>
                ...
                <flux:table.row>
                    ...
                    <flux:table.cell class="whitespace-normal">Two segments.arc using the canvas radius (default
                        2.75rem) turn the second inner FALSE
                ...
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal">notification-initialize.attach-to</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">null</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">The first inner loop's FALSE exit starts notification
                        setup once per group. Its before-length and after-length are explicitly 4rem.</flux:table.cell>
                </flux:table.row>
                <flux:table.row>
                    <flux:table.cell class="whitespace-normal">notification-return.return-to</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">required connection</flux:table.cell>
                    <flux:table.cell class="whitespace-normal">Targets notification-loop.anchorNode-return, never
                        the item loop or outer loop. Only notification-loop.anchorNode-end resumes the outer body.
                    </flux:table.cell>
                </flux:table.row>
                <flux:table.row>
    ...
    <flux:callout
        ...
        icon="eye"
    >
        <flux:callout.heading>Two independent inner loops · left / right</flux:callout.heading>
