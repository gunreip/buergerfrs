<x-translation-workbench::ui.common.heading-counter-group group="strang-branch-offset">
    <section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
        <flux:callout
            ...
            icon="file-text"
        >
            <flux:callout.heading>{{ __('Branch offset') }}</flux:callout.heading>
            <x-translation-workbench::ui.tw-graph.documentation-links example="strang.branch.branch-offset" />
            ...
            @php
                $docExampleSource = \Gunreip\TranslationWorkbench\Support\TwGraph\Documentation\ExampleSource::fromView(
                    'translation-workbench::pages.tw-graph.samples.documentation.idea-to-paper.strang.branch.branch-offset',
                );
            @endphp
            <flux:separator
                class="mt-4"
                ...
                <flux:accordion.item expanded>
                    ...
                    >
                        <x-translation-workbench::ui.common.heading-counter
                            example="branch-offset-example-1"
                            variant="accordion"
                            :prefix-text="__('Complete example')"
                        >{{ __('Branch offset') }}</x-translation-workbench::ui.common.heading-counter>
                    </flux:callout>
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $docExampleSource->example('branch-offset-example-1') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
            </flux:accordion>
            <flux:separator
            ...
            <flux:callout color="indigo">
                <flux:callout.heading icon="variable">{{ __('Branch offset props') }}</flux:callout.heading>
                ...
                <div class="mt-4 grid min-w-0 gap-4">
                    <div class="min-w-0">
                        ...
                        <div
                            ...
                            {{-- branch-offset-example-1:end --}}
                        </div>
                    </div>
                </div>
            </x-translation-workbench::ui.tw-graph.preview-tools>
            <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">
                .../idea-to-paper/strang/branch/branch-offset.blade.php
            </flux:field>
        </flux:callout>
    </section>
