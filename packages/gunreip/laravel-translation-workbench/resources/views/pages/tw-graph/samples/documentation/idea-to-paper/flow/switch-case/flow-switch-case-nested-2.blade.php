<section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
    ...
    >
        ...
        @php
            ...
            $docExample1Code = $docExampleSource->example('flow-switch-case-nested-2-example-1');
            $docExample2Code = $docExampleSource->example('flow-switch-case-nested-2-example-2');
        @endphp
        <flux:heading
            class="mt-3"
            size="sm"
        >Outer side="right" · Inner side="right"</flux:heading>
