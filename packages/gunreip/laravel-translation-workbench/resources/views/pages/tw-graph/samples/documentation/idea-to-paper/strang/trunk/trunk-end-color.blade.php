<x-translation-workbench::ui.common.heading-counter-group group="strang-trunk-end-color">
    <section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
        ...
        >
            ...
            <x-translation-workbench::ui.tw-graph.documentation-links example="strang.trunk.trunk-end-color" />
                ...
                <flux:accordion.item expanded>
                    ...
                    >
                        <x-translation-workbench::ui.common.heading-counter
                            example="trunk-end-color-example-1"
                            variant="accordion"
                            :prefix-text="__('Complete example')"
                        >{{ __('End color') }}</x-translation-workbench::ui.common.heading-counter>
                    </flux:callout>
                    <flux:accordion.content>
                        <x-translation-workbench::ui.tw-graph.code-box
                            class="mt-3">{{ $trunkExampleSource->example('trunk-end-color-example-1') }}</x-translation-workbench::ui.tw-graph.code-box>
                    </flux:accordion.content>
                </flux:accordion.item>
            </flux:accordion>
            <flux:separator
        ...
        >
            ...
            <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">
                .../idea-to-paper/strang/trunk/trunk-end-color.blade.php
            </flux:field>
        </flux:callout>
    </section>
