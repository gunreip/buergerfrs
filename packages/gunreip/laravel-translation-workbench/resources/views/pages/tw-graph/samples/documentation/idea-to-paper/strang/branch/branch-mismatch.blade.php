<section class="mt-4 grid min-w-0 gap-4 lg:grid-cols-2">
    ...
    >
        ...
        @php
            ...
            if (
                preg_match(
                    '/^[ \t]*\{\{-- branch-mismatch-example-1:start --\}\}\R(.*?)^[ \t]*\{\{-- branch-mismatch-example-1:end --\}\}/ms',
                    $docExampleSource,
                    $docExample1Match,
                ) !== 1
            ) {
                throw new \LogicException('Missing branch-mismatch-example-1 source markers.');
            }
        ...
        <flux:heading
            class="mt-4"
            size="sm"
        >{{ __('Branch mismatch props') }}</flux:heading>
    ...
    >
        ...
        <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">
            .../strang/branch/branch-mismatch.blade.php</flux:field>
    </flux:callout>
</section>
