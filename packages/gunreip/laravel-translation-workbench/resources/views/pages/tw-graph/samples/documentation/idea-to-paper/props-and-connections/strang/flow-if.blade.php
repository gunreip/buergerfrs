<section class="min-w-0 space-y-4" id="reference-strang-flow-if">
    <flux:heading size="lg">strang.flow-if — Deep Reference</flux:heading>
    <x-translation-workbench::ui.tw-graph.documentation-links reference="strang.flow-if" />
    <flux:text>One IF action with a final false bypass or optional fallback action.</flux:text>
        ...
        <flux:table class="mt-3">
            ...
            <flux:table.rows>
                ...
                <flux:table.row>
                    ...
                    <flux:table.cell class="whitespace-normal align-top">array | string | null</flux:table.cell>
                    <flux:table.cell class="whitespace-normal align-top">{&quot;text&quot;: [&quot;Action&quot;], &quot;width&quot;: &quot;half&quot;}</flux:table.cell>
    ...
    <flux:callout class="min-w-0 space-y-3" color="green" icon="brackets">
        ...
        <x-translation-workbench::ui.tw-graph.code-box class="mt-3">&lt;x-translation-workbench::ui.tw-graph.strang.flow-if
    id=&quot;example.flow-if&quot;
...
/&gt;</x-translation-workbench::ui.tw-graph.code-box>
    ...
    <flux:field class="m-3 flex justify-end font-mono text-xs text-zinc-400">.../props-and-connections/strang/flow-if.blade.php</flux:field>
</section>
