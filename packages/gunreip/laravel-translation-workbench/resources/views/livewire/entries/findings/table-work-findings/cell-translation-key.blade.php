        ...
        <div class="flex flex-wrap gap-1">
            ...
            @if ($wasBulkEqualized)
                <x-ui.tooltip.simple
                    ...
                    :text="__('This reviewed translation key was set through the bulk equalize workflow. Suggested and existing key context remain unchanged for audit/review history.')"
                >
                    <flux:badge
                        size="sm"
                        color="cyan"
