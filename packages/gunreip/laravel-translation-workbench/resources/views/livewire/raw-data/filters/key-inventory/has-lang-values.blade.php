{{-- packages/gunreip/laravel-translation-workbench/resources/views/livewire/raw-data/filters/key-inventory/has-lang-values.blade.php --}}

<flux:field class="{{ $fieldClass ?? '' }}">
    <flux:label>{{ __('Lang values') }}</flux:label>
    <flux:input.group>
        <flux:input.group.prefix>
            <flux:icon.languages />
        </flux:input.group.prefix>
        <flux:select wire:model.live="keyInventoryHasLangValues" variant="listbox">
