{{-- packages/gunreip/laravel-translation-workbench/resources/views/livewire/raw-data/filters/key-inventory/is-dynamic-multi.blade.php --}}
...
<flux:field class="{{ $fieldClass ?? '' }}">
    ...
    <flux:input.group>
        ...
        <flux:select wire:model.live="keyInventoryIsDynamicMulti" variant="listbox">
