{{-- packages/gunreip/laravel-translation-workbench/resources/views/livewire/raw-data/filters/key-inventory/is-orphaned-lang-value.blade.php --}}

<flux:field class="{{ $fieldClass ?? '' }}">
    <flux:label>{{ __('Orphaned lang value') }}</flux:label>
    <flux:input.group>
        <flux:input.group.prefix>
            <flux:icon.unlink />
        </flux:input.group.prefix>
        <flux:select wire:model.live="keyInventoryIsOrphanedLangValue" variant="listbox">
