{{-- packages/gunreip/laravel-translation-workbench/resources/views/livewire/raw-data/filters/key-inventory/has-active-code-usage.blade.php --}}

<flux:field class="{{ $fieldClass ?? '' }}">
    <flux:label>{{ __('Active code') }}</flux:label>
    <flux:input.group>
        <flux:input.group.prefix>
            <flux:icon.file-code />
        </flux:input.group.prefix>
        <flux:select wire:model.live="keyInventoryHasActiveCodeUsage" variant="listbox">
