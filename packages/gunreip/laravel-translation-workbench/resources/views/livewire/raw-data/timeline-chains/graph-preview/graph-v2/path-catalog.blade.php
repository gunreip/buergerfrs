    ...
    $pathRows = [
        ...
        [
            ...
            'composition' => [
                ...
                'stemLength controls the vertical path after start',
                'bridgeLength controls the horizontal segment',
            ],
            'props' => [
                'side=left',
                $tab . 'anchorStart{x,y}',
        ...
        [
            ...
            'composition' => [
                ...
                'bridgeLength controls the horizontal extension',
            ],
            'props' => [
                'side=left',
                $tab . 'anchorStart{x,y}',
        ...
        [
            ...
            'composition' => [
                ...
                'each next anchorStart is previous anchorEnd',
                'bridgeLength controls the horizontal segment',
                'stemLength controls the final vertical segment',
            ],
            'props' => [
                'side=left',
                $tab . 'anchorStart{x,y}',
        ...
        [
            ...
            'composition' => [
                ...
                'each next anchorStart is previous anchorEnd',
                'bridgeLength controls the horizontal return segment',
            ],
            'props' => [
                'side=left',
                $tab . 'anchorStart{x,y}',
        ...
        [
            'name' => 'branch-return-bridge left',
            'component' => '<x-translation-workbench::ui.tw-graph.paths.branch-return-bridge side="left"',
            'structure' => [
                'paths.branch-return-bridge.left',
                $tree . 'calculates anchor chain',
                $tree . 'segments.arc west-north',
                $tree . 'segments.path left-right',
            ],
            'composition' => [
                'one open branch-return bridge on the left side',
                'used by branch extensions when only arc -> bridge is needed',
                'bridgeLength controls the horizontal return bridge',
            ],
            'props' => [
                'side=left',
                $tab . 'anchorStart{x,y}',
            ...
            'view' => 'path-branch-return-bridge-left',
        ],
        [
            'name' => 'branch-return-bridge right',
            'component' => '<x-translation-workbench::ui.tw-graph.paths.branch-return-bridge side="right"',
            'structure' => [
                'paths.branch-return-bridge.right',
                $tree . 'calculates anchor chain',
                $tree . 'segments.arc east-north',
                $tree . 'segments.path right-left',
            ],
            'composition' => [
                'one open branch-return bridge on the right side',
                'used by branch extensions when only arc -> bridge is needed',
                'bridgeLength controls the horizontal return bridge',
            ],
            'props' => [
            ...
            'view' => 'path-branch-return-bridge-right',
        ],
        [
            ...
            'composition' => [
                ...
                'each next anchorStart is previous anchorEnd',
                'stemLength controls the first vertical segment',
                'bridgeLength controls the horizontal return segment',
            ],
            'props' => [
                'side=left',
