...
<div class="tw-graph-protocol-canvas content-center">
    @foreach ($segments as $segment)
        ...
        @elseif ($type === 'arc')
            <x-translation-workbench::ui.tw-graph-protocol.segments.arc
                :segment="$segment"
                :dev="$dev"
            />
        @elseif ($segmentName === 'trunk-start')
            <x-translation-workbench::ui.tw-graph-protocol.segments.start
                :segment="$segment"
                :dev="$dev"
            />
        @elseif ($segmentName === 'trunk-end' || (bool) data_get($segment, 'cap', false))
            <x-translation-workbench::ui.tw-graph-protocol.segments.end
                :segment="$segment"
                :dev="$dev"
            />
        @else
