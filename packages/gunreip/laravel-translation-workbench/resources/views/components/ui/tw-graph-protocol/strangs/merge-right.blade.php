...
@php
    ...
    $strangBorderLeft = $subtract($mergeTopAnchor['x'], $strangBorderPadding);
    $strangBorderBottom = $subtract($lowestExtensionAnchor['y'], $strangBorderPadding);
    $strangBorderWidth = $add($diff($outermostExtensionAnchor['x'], $mergeTopAnchor['x']), $add($strangBorderPadding, $strangBorderPadding));
