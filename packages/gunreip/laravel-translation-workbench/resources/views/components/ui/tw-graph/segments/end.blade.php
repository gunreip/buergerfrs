...
{{--
    ...
    Usage:
    <x-translation-workbench::ui.tw-graph.segments.end :segment="$segment" />
...
@if (filled(data_get($endSegment, 'endLabel.text')))
    <x-translation-workbench::ui.tw-graph.primitives.text
        ...
        :long="data_get($endSegment, 'endLabel.long', false)"
        :half-long="data_get($endSegment, 'endLabel.halfLong', false)"
    />
@endif
