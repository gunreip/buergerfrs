...
{{--
    ...
    <x-translation-workbench::ui.tw-graph.strang.branch-left
        ...
        :continuation-stem="[1 => ['3rem'], 2 => ['3rem']]"
        :branch-extension="[
            'node.2' => [
                1 => ['bridgeLength' => '5rem', 'stemHeight' => '3rem'],
            ],
            'continuation.1' => [
...
@php
    ...
    $node2 = [
        'x' => $subtract($node1['x'], $resolvedBridgeLength),
        'y' => $node1['y'],
    ...
    \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::put($resolvedGraphId, 'strang.branch-left.end', $continuationEnd);

    foreach ($continuationAnchors as $continuationNumber => $continuationAnchor) {
        \Gunreip\TranslationWorkbench\Support\TwGraph\AnchorRegistry::put($resolvedGraphId, 'strang.branch-left.continuation.' . $continuationNumber, $continuationAnchor);
    }
