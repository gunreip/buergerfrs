{{-- packages/gunreip/laravel-translation-workbench/resources/views/components/ui/tw-graph-protocol.blade.php --}}
{{--
    Protocol-driven graph renderer.

    Package rule:
    tw-graph-protocol is owned by the translation-workbench package. The JSON
    protocol is the source of truth for calculated coordinates; this component
    only renders resolved protocol data through package-local primitives,
    segments, paths, and strangs.

    Usage:
    <x-translation-workbench::ui.tw-graph-protocol :protocol="$protocol" />
--}}
