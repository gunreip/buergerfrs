{{-- packages/gunreip/laravel-translation-workbench/resources/views/components/ui/tw-graph-protocol/segments/arc.blade.php --}}
{{--
    Segment: arc

    Usage:
    <x-translation-workbench::ui.tw-graph-protocol.segments.arc :segment="$segment" />
