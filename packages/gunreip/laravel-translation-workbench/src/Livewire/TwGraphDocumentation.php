...
class TwGraphDocumentation extends Component
{
    ...
    private const TABS = [
        ...
        'flow_index' => ['flow-start', 'flow-step', 'flow-branch-steps', 'flow-if', 'flow-switch-case'],
        'flow_switch_case' => ['flow-switch-case-default', 'flow-switch-case-grouped', 'flow-switch-case-grouped-3', 'flow-switch-case-grouped-multi', 'flow-switch-case-nested', 'flow-switch-case-without-default', 'flow-switch-case-fallthrough', 'flow-switch-case-test'],
