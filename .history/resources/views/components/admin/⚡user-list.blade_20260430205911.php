...
<flux:card>
    ...
    <flux:card class="mt-6">
        <div class="mx-auto max-w-4xl p-3">
            <flux:table>
                <caption class="caption-top text-zinc-400 md:caption-bottom">
                    {{ __('List of all registered users. Click on a column header to sort by that column.') }}
                </caption>
                <flux:table.columns class="rounded rounded-t-lg bg-zinc-800 text-zinc-400">
                    <flux:table.column
                        {{-- class="rounded rounded-tl-lg border border-r-zinc-400/70 bg-zinc-800 text-zinc-400" --}}
                        sortable
                    ...
                    <flux:table.column
                        {{-- class="border border-r-zinc-400/70 bg-zinc-800 text-zinc-400" --}}
                        sortable
                    ...
                    <flux:table.column
                        {{-- class="rounded rounded-tr-lg border border-r-zinc-400/70 bg-zinc-800 text-zinc-400" --}}
                        align="center"
                    >
                        {{ __('Actions') }}
                    </flux:table.column>
