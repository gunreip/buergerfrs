    ...
    <flux:card class="mt-6">
        <div class="mx-auto max-w-4xl p-3">
            <flux:table>
                ...
                <flux:table.columns>
                    <flux:table.column
                        class="rounded rounded-tl-lg border border-r-zinc-700/70 bg-zinc-800 text-zinc-400"
                        sortable
                    ...
                    <flux:table.column
                        class="border border-r-zinc-700/70 bg-zinc-800 text-zinc-400"
                        sortable
                    ...
                    <flux:table.column
                        class="rounded rounded-tr-lg border border-r-zinc-700/70 bg-zinc-800 text-zinc-400"
                        align="center"
                    >
                        {{ __('Actions') }}
                    </flux:table.column>
